...
public class CheckParamUtil {
    ...
    public static boolean checkbase64(String inputStr) {
     ...
     * @return
     */
    public static Boolean checkNamenew(String name) {
        if(StringUtils.isEmpty(name)){
            return true;
        }
        String regex="^[A-Za-z]{1,20}$|^[A-Za-z]{1,20}(?: [A-Za-z]{1,10})+$|^[\\u2E80-\\uFE4F]{1,15}$|^[\\u2E80-\\uFE4F]{1,15}(?:·[\\u2E80-\\uFE4F]{1,15})+$";
    ...
    /**
     * 判断输个入的姓名是否合法（2到8个字的汉字,或者2到16个字的英文）
     */
    public static Boolean checkSimpleName(String name) {
        if(StringUtils.isEmpty(name)){
            return true;
        }
        //String regex="^(([\\\\u4e00-\\\\u9fa5]{1,10})|([a-zA-Z]{2,16}))$";
        String regex="^(([\\u2E80-\\uFE4F]{1,10})|([a-zA-Z]{2,16}))$";
